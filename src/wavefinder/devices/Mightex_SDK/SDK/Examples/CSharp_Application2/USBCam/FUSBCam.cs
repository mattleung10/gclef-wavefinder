    ...
    public partial class FUSBCam : Form
    {
        ...
        public FUSBCam()
        {
            ...
            if (_numCams > 0)
            {
                ...
                CBResolution.SelectedIndex = (int)CCameraUSB.RESOLUTION.NORMAL;
        ...
        private void CBCameraSelect_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            myUSBCam.SetResolution(CCameraUSB.RESOLUTION.NORMAL, 0);
            myUSBCam.SetGain(8, 8, 8);
            ...
            //myUSBCam.SetHorzMirr( true );
            //myUSBCam.SetFlipVert( true );
        ...
        private void CBResolution_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (_startedContFG)
            {
                myUSBCam.SetResolution((CCameraUSB.RESOLUTION)CBResolution.SelectedIndex, 0);
            }
        }
        ...
        public void SetCallBackMessage( ref ImageProperty imageProp, uint pixelAvg, IntPtr Buffer )
        {
            ...
            IntPtr recentImg = (IntPtr)Buffer;
            ...
            //myBMP.Save("kkk.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            PBImage.Image = myBMP;
        }
