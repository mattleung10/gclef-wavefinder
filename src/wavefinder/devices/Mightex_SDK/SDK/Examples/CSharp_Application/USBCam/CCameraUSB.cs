...
// Important, this example is for mightex CCX-B013-U or CCX-C013-U camera, for other
// modals, user might have to adjust the resolution definiction...etc. for it to run correctly.
...
namespace USBCam
{
    ...
    public class CCameraUSB
    {
        ...
        public CCameraUSB( FUSBCam mightexCamera )
        {
            ...
            //_imgControl._rowSize = 1280;    // For CGX-B013 or CGX-C013
            //_imgControl._columnSize = 960; // 
            ...
            _maxX = 1392; // Assume we're using CCX-X013-U camera
            _maxY = 1040; 
            //_maxX = 1280; // For CGX-X013
            //_maxY = 960; 
        }
        ...
        public void GrabbingFrameCallback(  ref ImageProperty frameProperty, IntPtr BufferPtr)
        {
            ...
            unsafe
            {
                 ...
                 */
                pixelAvg = 0;
                frameSize = (uint)(frameProperty.Row * frameProperty.Column) ;
        ...
        private void SetMaxXY(RESOLUTION res)
        {
            ...
            /* For CGX-B013 or CGX-C013 cameras.
            switch (res)
            {
                case RESOLUTION.TINY:
                    _maxX = 1280;
