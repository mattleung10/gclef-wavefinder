...
uses
  ...
  ExtCtrls, RzPanel, RzRadGrp, RzButton, DataTypes, DllInterface, StdCtrls;
...
type
  TDeviceForm = class(TForm)
    ...
    CameraBitRadioGroup: TRadioGroup;
...
begin
  ...
  if CameraBitRadioGroup.ItemIndex = 0 then
    Is8BitCamera := True
  else
    Is8BitCamera := False; // 10bit Camera
  Close;
end;
