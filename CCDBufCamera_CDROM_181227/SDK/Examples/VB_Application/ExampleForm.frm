...
Private Sub Command11_Click()
    BUFCCDUSB_StartFrameGrab 100000
End Sub
...
Private Sub Command13_Click()
    BUFCCDUSB_SetCustomizedResolution 1, 1392, 520, &H81, 4  'For CCX camera, it's different
                                                             'for CGX camera, please refer to SDK manual
End Sub

Private Sub Command14_Click()
    BUFCCDUSB_SetGains 1, 16, 16, 16
End Sub

Private Sub Command15_Click()
    BUFCCDUSB_SetExposureTime 1, 100  '100x50us = 5ms
End Sub

Private Sub Command17_Click()
    BUFCCDUSB_SetCameraWorkMode 1, NORMAL_MODE
End Sub

Private Sub Command18_Click()
    BUFCCDUSB_SetCameraWorkMode 1, TRIGGER_MODE
End Sub

Private Sub Command19_Click()
    BUFCCDUSB_SetGPIOConifg 1, &H3  'Pin1&2 as Input, 3&4 as Output
End Sub

Private Sub Command20_Click()
    Dim InputState As Byte
    BUFCCDUSB_SetGPIOInOut 1, &H4, InputState   ' High for Pin3, Low for Pin4
End Sub

Private Sub Command21_Click()
    BUFCCDUSB_InstallFrameHooker RAWDATA_IMAGE, AddressOf MyFrameHooker
End Sub

Private Sub Command22_Click()
    BUFCCDUSB_InstallFrameHooker RAWDATA_IMAGE, 0
End Sub
...
Private Sub Command4_Click()
    ...
    ModuleName = Space(32)
    SerialName = Space(32)
    BUFCCDUSB_GetModuleNoSerialNo 1, ModuleName, SerialName
...
Private Sub Command6_Click()
    ...
    BUFCCDUSB_StartCameraEngine hWnd, 8  '8bit camera
End Sub
